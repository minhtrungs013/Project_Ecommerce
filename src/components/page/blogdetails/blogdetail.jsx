...
import Blognavigate from "../blog/blognavigate";
import blogdetailimg from "../../../assets/img/details-pic.jpg.webp";
import blogdetailauth from "../../../assets/img/details-author.jpg.webp";
...
export default function blogdetail() {
  return (
    <div className="container blogpage">
      <div className="blogpage__detail">
        <FontAwesomeIcon
          icon={faBlog}
          className="blog__detail-icon"
        ></FontAwesomeIcon>
        <h2 className="blogpage_heading-detail">
